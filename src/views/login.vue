...
.icon-logo-login {
  width: 39px;
  height: 40px;
  background: url(~@/../public/loginImages/icon_logo.png) left top / 100% 100%;
}
.icon-lock {
  width: 14px;
  height: 15px;
  background: url(~@/../public/loginImages/icon_user.png) left bottom;
}
.icon-user {
  width: 14px;
  height: 15px;
  background: url(~@/../public/loginImages/icon_user.png) left top;
}
.btn-gray-delete {
  width: 14px;
  height: 14px;
...
#login {
  ...
  align-items: center;
  height: 100%;
  background: url(~@/../public/loginImages/bg.png) center center / 100% 100% no-repeat;
}
#login > img {
  display: block;
  margin-right: 230px;
...
#login .title1 {
  ...
  line-height: 40px;
  text-align: center;
  background: url(~@/../public/loginImages/font.png) no-repeat center;
}
#login .m-gallery {
  position: relative;
  width: 502px;
...
#login .m-login .wrap-login:before {
  ...
  margin: 0 auto;
  z-index: 1;
  background: url(~@/../public/loginImages/point.png) left top no-repeat;
}
