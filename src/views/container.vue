 ...
 * @Last Modified time: 2018-11-01 17:45:51
 */
<template>
  ...
  methods: {
    ...
    loginStatus () {
      const tokenList = {
        ...
        'jNvmqMJBIzgdYFrNAp79DCykw1H1aHdLB2I0g/HIdfi2dKqHIPTae4Lf': { name: '彭森', userName: 'sh_pengsen00', areaCode: 'SHJCK01000' },
        ...
        'j9fmtNJWJSUIZwSaH924IziewUP/bHcLXj1hgOyKL6r1YKqHJ77Ad5+Yt0n/FQ==': { name: '陆燕萍', userName: 'pd_luyanping00', areaCode: 'SHJCK01014030' },
        ...
        'nN3mu9JGKCIAZwvNH8D2PQOi2F/qZGESVmM2ge6IMOqwcqyBIbjBO4TYsU4=': { name: '崔莉霞', userName: 'cn_cuilixia ', areaCode: 'SHJCK01008' },
        'j8fmr8ZBIyYRYFrNAp3hDCugw1HrZHdLB2I0g/HIdfi2dKqHIPTae4Lf': { name: '王敏', userName: 'pt_wangmin00', areaCode: 'SHJCK01006' },
        'j8fmu89KKicRYgPNH8DlJwOixVPoYXAXXmM2ge6IMOqwcqyBIbjBO4TYsU4=': { name: '陈莉丽', userName: 'pt_chenlili00', areaCode: 'SHJCK01006' },
        'l9jmos9AMToRe1rNAoX+DCapwkP3ZGxLB2I0g/HIdfi2dKqHIPTae4Lf': { name: '周球', userName: 'hk_zhouqiu00', areaCode: 'SHJCK01001' },
        'hsPmtM5CLSVIPEeEX7L5OjGowwa0PCtIGiBu0bLcdfixPrCLPbM=': { name: '李旻', userName: 'yp_limin02', areaCode: 'SHJCK01003' },
        'l8Pmr8ZBIzwdZxOUH924Oyye2lfoam4eXipvgOyKL6r1YKqHJ77Ad5+Yt0n/FQ==': { name: '王伟毅', userName: 'hp_wangweiyi00', areaCode: 'SHJCK01002' },
        'ldLmr9JeMSVIPkeXTrLiJi20wwa2PCtIGiBu0bLcdfixPrCLPbM=': { name: '吴群  ', userName: 'ja_wuqun00', areaCode: 'SHJCK01009' },
        'ldLmq89GPCIZYROcH924OT2e3l7vdXAaWCpngOyKL6r1YKqHJ77Ad5+Yt0n/FQ==': { name: '史小娅', userName: 'ja_shixiaoya00', areaCode: 'SHJCK01009' },
        'ktvmoNJFLSoWZh+cH9+4PjSe1UPsZHgVXyZngO6KL6r1YKqHJ77Ad5+Yt0n/FQ==': { name: '徐建华', userName: 'mh_xujianhua02 ', areaCode: 'SHJCK01012' },
        'ncDmtM5XLSoXfgOTSN2lfj6y8lrvdXAaWCNv3ruLLbSre6OILrHJf9vHqFDh': { name: '李晓平', userName: 'bs_lixiaoping', areaCode: 'SHJCK01011' },
        'ldfmqc5aLiIZYAaUToPyY2zsx1LZfHAOXTpn3rDSfPe/I/LXe+qFZZ7Uq0PjHvBycWyYoA==': { name: '仇建良', userName: 'jd_qiujianliang00', areaCode: 'SHJCK01013' },
        'lcDmqMJGPCIXYA2MRoPyY2zsx0XZfXwSTzpp3rvKdPe/I/LXe+qFZZ7Uq0PjHvBycWyYoA==': { name: '裴雄卿', userName: 'js_peixiongqing00 ', areaCode: 'SHJCK01010' },
        'jNnmtNJMLCoXdwuTSN2lfi+r8lrzbnEaWCpn3ruLLajqIO+VIbjGcZ7UrAn5Eu01': { name: '陆朝阳', userName: 'sj_luchaoyang00', areaCode: 'SHJCK01018' },
        'jsPmochaLiIZYAKITt2lfi2x8k/peHMSVj1uxb2LLajqIO+VIbjGcZ7UrAn5Eu01': { name: '尤建华', userName: 'qp_youjianhua00', areaCode: 'SHJCK01017' },
        'jsPmu89KKiUZYFrNApzlDD+pyFjobHdLB2I0g/HIdfi2dKqHIPTae4Lf': { name: '陈楠', userName: 'qp_chennan00', areaCode: 'SHJCK01017' },
        ...
        'nN7mtM5aLiIWaQiSH9y4MDGewV/zZ3AVUDFpgO2KL6r1YKqHJ77Ad5+Yt0n/FQ==': { name: '刘静波', userName: 'cm_liujingbo01', areaCode: 'SHJCK01019' }
      }
